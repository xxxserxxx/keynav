...
Toggle keynav.  If keynav is active, this makes it inactive.  If keynav is
inactive, this makes it active.
...
=item B<sleep> I<milliseconds>

Pause for this amount of time. Useful in macros where keynav plays back faster
than an application GUI can respond to.
...
https://raw.githubusercontent.com/yjftsjthsd-g/keynav/master/examples/keynavrc.jordan

=head1 SEE ALSO

Related: L<xdotool(1)>

Original project site: L<http://www.semicomplete.com/projects/keynav>

Github: L<https://github.com/yjftsjthsd-g/keynav>

=head1 CONTACT

For all questions, comments, bugs, and feature requests, please open an issue at:

L<https://github.com/yjftsjthsd-g/keynav/issues>
